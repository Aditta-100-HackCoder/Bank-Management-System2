...
<body style="background: url(images/im1.jpg);background-size: 100%"> 
<h1 style = "color:#4287f5;padding-top: 140px" ><span class="type"></span>MCB BANK </h1> 
...
var typed = new Typed('.type', {
 strings: ['Welcome to our Bank management System',
...
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
	<br><h4 class="text-center text-white">Login form</h4>
