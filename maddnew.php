    ...
    <table class="table">
      <tbody>
        ...
        <tr> <th>Account Number</th>
          <!--<td><input type=" " name="accountNo" readonly value="" class="form-control input-sm" required></td>-->
          <td><input type="text" name="accountNo" class="form-control input-sm" required></td>
          <th>Account Type</th>
          <td>
